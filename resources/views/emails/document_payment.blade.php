...
<head>
    <meta charset="utf-8">
    <title>Product Drop Receipt</title>
    <style>
        ...
        .accent { color: #c084fc; }
        .amount-badge { font-size: 32px; font-weight: 900; color: #c084fc; text-align: center; margin: 16px 0; }
...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <h2 style="font-size: 18px; text-align: center; color: #ffffff; margin: 0;">Product Drop Unlocked</h2>
            
            <div class="amount-badge">€{{ number_format($payment->amount, 2) }}</div>

            <p style="text-align: center; font-size: 13px; color: #a1a1aa;">
                Your product copy generation has been completed successfully. Attached is your official B2B PDF invoice.
            </p>
            ...
            <div style="text-align: center;">
                <a href="{{ url('/dashboard') }}" class="cta-btn">View in Dashboard</a>
            </div>
        </div>
